...
enum {
	...
	SENS_ON_OFF,	     // XY*5# - включение/отключение отдельных датчиков
				// где X - индекс датчика в массиве sensors[] (см. ниже в этом файле)
				// Y - 0 или 1, отключено или включено соответственно.
				// Например отключим 0 датчик (геркон) - 0*5#, включим - 1*5#
				// отключим 2 датчик (PIR датчик) - 20*5#, включим 21*5#
...
/*
    ...
    6 - значение для срабатывания аналогового датчика, по умолчанию равно ANALOG_SIGN_ALARM_VALUE
*/
